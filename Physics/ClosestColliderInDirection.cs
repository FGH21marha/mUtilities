// Written by Martin Halldin (https://github.com/FGH21marha/mUtilities/Physics/)
using UnityEngine;

public static class ClosestColliderInDirection
{
    // Returns the closest collider in the specified direction.
    public static bool Calculate(Vector3 position, float radius, Vector3 dir, LayerMask mask, float margin, System.Action<RaycastHit> onCollision)
    {
